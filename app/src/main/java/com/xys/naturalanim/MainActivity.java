...
import com.xys.naturalanim.interpolator.BackInInterpolator;
import com.xys.naturalanim.interpolator.BackInOutInterpolator;
import com.xys.naturalanim.interpolator.BackOutInterpolator;
import com.xys.naturalanim.interpolator.BounceInInterpolator;
import com.xys.naturalanim.interpolator.BounceInOutInterpolator;
import com.xys.naturalanim.interpolator.BounceOutInterpolator;
import com.xys.naturalanim.interpolator.BreathInterpolator;
import com.xys.naturalanim.interpolator.CircleInInterpolator;
import com.xys.naturalanim.interpolator.CircleInOutInterpolator;
import com.xys.naturalanim.interpolator.CircleOutInterpolator;
import com.xys.naturalanim.interpolator.CubicInInterpolator;
import com.xys.naturalanim.interpolator.CubicInOutInterpolator;
import com.xys.naturalanim.interpolator.CubicOutInterpolator;
import com.xys.naturalanim.interpolator.ElasticInInterpolator;
import com.xys.naturalanim.interpolator.ElasticInOutInterpolator;
import com.xys.naturalanim.interpolator.ElasticOutInterpolator;
import com.xys.naturalanim.interpolator.ExpoInInterpolator;
import com.xys.naturalanim.interpolator.ExpoInOutInterpolator;
import com.xys.naturalanim.interpolator.ExpoOutInterpolator;
import com.xys.naturalanim.interpolator.QuadInInterpolator;
import com.xys.naturalanim.interpolator.QuadInOutInterpolator;
import com.xys.naturalanim.interpolator.QuadOutInterpolator;
import com.xys.naturalanim.interpolator.QuartInInterpolator;
import com.xys.naturalanim.interpolator.QuartInOutInterpolator;
import com.xys.naturalanim.interpolator.QuartOutInterpolator;
import com.xys.naturalanim.interpolator.QuintInInterpolator;
import com.xys.naturalanim.interpolator.QuintInOutInterpolator;
import com.xys.naturalanim.interpolator.QuintOutInterpolator;
import com.xys.naturalanim.interpolator.SineInInterpolator;
import com.xys.naturalanim.interpolator.SineInOutInterpolator;
import com.xys.naturalanim.interpolator.SineOutInterpolator;
import com.xys.naturalanim.interpolator.SpringInterpolator;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initSpinner() {
        ...
        listChoose.add(new BackInInterpolator());
        listChoose.add(new BackOutInterpolator());
        listChoose.add(new BackInOutInterpolator());
        listChoose.add(new BounceInInterpolator());
        listChoose.add(new BounceOutInterpolator());
        listChoose.add(new BounceInOutInterpolator());
        listChoose.add(new BreathInterpolator());
        listChoose.add(new CircleInInterpolator());
        listChoose.add(new CircleOutInterpolator());
        listChoose.add(new CircleInOutInterpolator());
        listChoose.add(new CubicInInterpolator());
        listChoose.add(new CubicOutInterpolator());
        listChoose.add(new CubicInOutInterpolator());
        listChoose.add(new ElasticInInterpolator(mDuration));
        listChoose.add(new ElasticOutInterpolator(mDuration));
        listChoose.add(new ElasticInOutInterpolator(mDuration));
        listChoose.add(new ExpoInInterpolator());
        listChoose.add(new ExpoOutInterpolator());
        listChoose.add(new ExpoInOutInterpolator());
        listChoose.add(new QuadInInterpolator());
        listChoose.add(new QuadOutInterpolator());
        listChoose.add(new QuadInOutInterpolator());
        listChoose.add(new QuartInInterpolator());
        listChoose.add(new QuartOutInterpolator());
        listChoose.add(new QuartInOutInterpolator());
        listChoose.add(new QuintInInterpolator());
        listChoose.add(new QuintOutInterpolator());
        listChoose.add(new QuintInOutInterpolator());
        listChoose.add(new SineInInterpolator());
        listChoose.add(new SineOutInterpolator());
        listChoose.add(new SineInOutInterpolator());
        listChoose.add(new SpringInterpolator());
